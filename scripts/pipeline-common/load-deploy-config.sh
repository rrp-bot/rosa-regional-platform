...
export OWNER
export ORGANIZATION
export MANAGED_BY_INTEGRATION
export APP
export ENABLE_BASTION
export ENVIRONMENT_DOMAIN

echo "  APP_CODE=$APP_CODE SERVICE_PHASE=$SERVICE_PHASE COST_CENTER=$COST_CENTER OWNER=$OWNER ORGANIZATION=$ORGANIZATION MANAGED_BY_INTEGRATION=$MANAGED_BY_INTEGRATION APP=$APP"
